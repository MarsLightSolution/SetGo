...
export default function UserInfo() {
  ...
  const [boostedProducts, setBoostedProducts] = useState(new Set())
  ...
  const boostAd = async (id) => {
    try {
      ...
      setBoostedProducts((prev) => new Set([...prev, id]))
      setAds((prev) =>
        prev.map((ad) =>
                    ...
                    <div className="flex flex-col justify-between flex-grow p-4">
                      ...
                      <div className="flex gap-2 mt-4 justify-center">
                        ...
                        <button
                          ...
                          disabled={boostedProducts.has(ad._id)}
                          className={`${
                            boostedProducts.has(ad._id)
                          ...
                          title={boostedProducts.has(ad._id) ? "Already Boosted" : "Boost Ad"}
                        >

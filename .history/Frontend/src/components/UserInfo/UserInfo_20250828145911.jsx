...
const ConfirmDialog = ({ onConfirm, onCancel, action = "pause", adSoldStatus = false }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/10">
      <div className="bg-white rounded-xl p-6 shadow-2xl w-[350px] text-center border border-gray-200">
          ...
          {isBoost
            ...
            : isPause
              ? adSoldStatus
                ...
                : "Are you sure you want to mark this ad as sold? It will be hidden from listings."
        ...
        <div className="flex justify-center gap-4">
          ...
          >
            {isBoost ? "Yes, Boost" : isPause ? (adSoldStatus ? "Yes, Resume" : "Yes, Mark Sold") : "Yes, Delete"}
          </button>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      {confirmAdId && (
        <ConfirmDialog
          ...
          adSoldStatus={ads.find((ad) => ad._id === confirmAdId)?.sold || false} // Pass the sold status to dialog
        />
      )}
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between flex-grow p-4">
                      ...
                      <div className="flex gap-2 mt-4 justify-center">
                        ...
                        >
                          {ad.sold ? <FaPlay className="w-4 h-4" /> : <FaPause className="w-4 h-4" />}
                        </button>
                        <button
                          onClick={(e) => {
                            e.stopPropagation()

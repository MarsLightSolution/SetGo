...
import {
  ...
  setCategoryFilter,
  setPostalCode,
  setLocationFilter, // Added import for setLocationFilter
        ...
        <div className="bg-white shadow-sm">
          <div className="max-w-[864px] mx-auto flex justify-between items-center px-4 py-4">
            <div className="flex items-center space-x-2 cursor-pointer" onClick={() => navigate("/")}>
              ...
              <span className="text-xl md:text-2xl font-semibold text-[#2e4a2f]">kleinanzeigen</span>
            </div>
        ...
        <div className="bg-lime-400 py-4">
          <div className="max-w-[900px] mx-auto px-4">
            <div className="hidden md:flex items-center justify-between gap-4">
              {/* Search Box */}
              <div className="flex bg-white rounded-full shadow px-4 h-12 flex-1 items-center gap-3">
                {/* Search Input */}
                ...
                <button
                  className="ml-2 p-2 bg-white rounded-full shadow hover:bg-gray-100 cursor-pointer flex-shrink-0"
                ...
                {/* Category Select */}
                <select
                  className="text-sm text-gray-700 outline-none border-l pl-4 flex-shrink-0 min-w-[120px]"
                ...
                {/* Postal Code Input */}
                <div className="flex items-center gap-2 border-l border-gray-300 pl-4 flex-shrink-0 min-w-[100px]">
                ...
                <button
                  ...
                  className="ml-1 bg-lime-500 hover:bg-lime-600 text-white font-semibold px-6 py-1.5 rounded-full flex-shrink-0"
                >
                  {t("navbar.find")}
                </button>
              </div>

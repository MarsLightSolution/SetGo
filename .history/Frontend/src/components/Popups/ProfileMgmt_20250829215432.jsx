  ...
  <div className="min-h-screen bg-gray-50 py-6 sm:py-10">
    ...
    <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-md border border-gray-200 flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-gray-200 p-4 sm:p-6">
        ...
        <nav className="grid grid-cols-2 md:grid-cols-1 gap-2 sm:space-y-1">
          <button
            onClick={() => navigate('/profile')}
            className="flex items-center px-3 py-2 text-sm font-medium text-green-700 bg-green-50 rounded-md cursor-pointer"
          >
            <span className="mr-2 sm:mr-3">👤</span>
            {t("profileMgmt.profileInfo")}
          </button>
          <button
            onClick={() => navigate('/accountsettings')}
            className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md cursor-pointer"
          >
            <span className="mr-2 sm:mr-3">⚙️</span>
            {t("profileMgmt.accountSettings")}
          </button>
          <button
          ...
          >
            <span className="mr-2 sm:mr-3">❤️</span>
            {t("profileMgmt.aboutClassifiedAds")}
          </button>
        </nav>
      </div>
      ...
      <div className="flex-1 p-4 sm:p-6">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">
          {t("profileMgmt.profileInfoTitle")}
        </h2>
        <div className="space-y-4 sm:space-y-6">
          
          {/* Profile Name */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-4 border-b border-gray-100 gap-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-4 border-b border-gray-100 gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
              <label className="text-sm font-medium text-gray-700 w-32">
                {t("profileMgmt.deliveryAddressLabel")}
              </label>
              <div className="text-gray-900 text-sm">
                {profile.deliveryAddress || t('profileMgmt.notAvailable')}
              </div>
            </div>
            <button
              className="text-green-600 hover:text-green-700 text-sm cursor-pointer self-start sm:self-auto"

        ...
        for (let file of filesArray) {
          try {
            ...
            if (isHeic) {
              ...
              // heic2any may return an array, pick the first blob
            ...
            showErrorToast(`${file.name} ${t("form.imageCompressionFailed")}`);
          }
        }
...
{loading && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
    <div className="p-4 bg-white/30 backdrop-blur-md rounded-2xl shadow-lg">
      <CircularProgress color="success" size={50} thickness={3} />
    </div>
  </div>
)}
  ...
  <div className="border-2 border-dashed border-gray-400 rounded-lg p-6 text-center cursor-pointer hover:border-green-600 transition-all relative">
    <input
      type="file"
      multiple
      accept="image/*"
    ...
    {loading && (
      <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/20 backdrop-blur-sm rounded-lg">
        <div className="p-4 bg-white/30 backdrop-blur-md rounded-xl shadow-lg">
          <CircularProgress color="success" size={40} thickness={3} />
        </div>
      </div>
    )}
  </div>

                  ...
                  {galleryLoading ? (
                    ...
                    galleryData.map((item, index) => (
                      <div
                        ...
                        className="min-w-[160px] max-w-[180px] max-h-1 flex-shrink-0 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md cursor-pointer transition-all duration-300 hover:scale-105 group relative overflow-hidden"
                      >

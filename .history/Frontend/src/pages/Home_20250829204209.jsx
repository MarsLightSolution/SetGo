    ...
    {galleryLoading ? (
      ...
      galleryData.map((item, index) => (
        <motion.div
          ...
          className="min-w-[220px] max-w-[220px] flex-shrink-0 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-xl cursor-pointer transition-all relative overflow-hidden group"
        >
          {/* Image */}
          <div className="relative w-full h-[160px] bg-gray-50 flex justify-center items-center overflow-hidden rounded-t-xl">
            <img
            ...
            />
            {/* Floating Badge */}
            <span className="absolute top-2 left-2 bg-white/90 text-green-600 text-xs font-semibold px-2 py-1 rounded-lg shadow">
              {t("home.featured")}
            </span>
          </div>

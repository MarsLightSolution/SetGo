  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-[2rem]">
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
        className="bg-white p-5 rounded-2xl shadow-lg w-full md:w-[40%] h-[395px] overflow-y-auto border border-gray-100"
      >
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.5 }}
        className="bg-white p-5 rounded-2xl shadow-lg border border-gray-100 flex-1 w-40 md:w-[40%]"
      >
        {/* Header */}

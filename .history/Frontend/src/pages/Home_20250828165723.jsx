...
const Home = () => {
        ...
        <div className="w-full max-w-screen-xl px-4 flex flex-wrap gap-4 items-start">
          ...
          <div className="flex-1 flex flex-col gap-3 w-full lg:w-auto">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {/* Gallery */}
             <div className="bg-gradient-to-r from-green-50 via-white to-green-50 p-6 rounded-2xl shadow-xl flex-1 w-full md:w-[65%] border border-green-100">
  <div className="flex justify-between items-center mb-4">
    ...
    <div className="flex gap-2">
      <button
        className="px-3 py-1 bg-green-600 text-white text-xs rounded-lg hover:bg-green-700 disabled:opacity-50 shadow-md transition-all"
      ...
      <button
        className="w-9 h-9 border border-green-300 rounded-full flex items-center justify-center text-green-700 hover:bg-green-50 transition-all shadow-sm"
    ...
    {galleryLoading ? (
      ...
      galleryData.map((item, index) => (
        <div
          ...
          className="relative min-w-[180px] max-w-[200px] bg-white border-2 border-green-100 rounded-xl shadow-lg hover:shadow-2xl cursor-pointer transition-all duration-300 hover:scale-105 group overflow-hidden"
        >
          {/* Badge */}
          {/* Image */}
          <div className="w-full h-[150px] bg-gray-50 flex justify-center items-center overflow-hidden rounded-t-xl">
            <img
          ...
          {/* Glow effect */}
          <div className="absolute inset-0 bg-gradient-to-t from-green-100/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl"></div>
        </div>
      ))
    ) : (
      <div className="flex items-center justify-center w-full h-[200px]">

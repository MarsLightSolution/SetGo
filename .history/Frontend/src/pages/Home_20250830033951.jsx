        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className="bg-white p-5 rounded-2xl shadow-lg w-full md:w-1/3 h-[395px] overflow-y-auto border border-gray-100"
            >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
              className="bg-white p-5 rounded-2xl shadow-lg border border-gray-100 flex-1"
            >
              {/* Header */}
                ...
                {galleryLoading ? (
                  ...
                  galleryData.map((item) => (
                    <motion.div
                      ...
                      className="bg-white border border-gray-200 rounded-2xl shadow-md hover:shadow-xl cursor-pointer transition-all relative overflow-hidden group"
                    >
                      {/* Image */}

...
>
  {galleryLoading ? (
    <div className="flex items-center justify-center w-full h-[200px] col-span-full">
    ...
    galleryData.map((item) => (
      ...
      >
        {/* Image */}
        <div className="w-full h-[180px] bg-gray-50 flex justify-center items-center overflow-hidden rounded-t-2xl relative">
          <img

...
const AdCard = ({ ad, image, price, description, condition, name, createdAt }) => {
  ...
  return (
    <div
      ...
      className="relative group cursor-pointer hover:scale-105 transition duration-300 ease-in flex flex-col items-center justify-between border border-gray-200 shadow-md hover:shadow-lg gap-3 p-3 rounded-xl w-[220px] sm:w-[200px] bg-white"
    >
      {/* Like Button */}
      {token && (
        <button
      ...
      {/* Image */}
      <div className="w-full h-[140px] flex justify-center items-center bg-gray-50 rounded-md overflow-hidden">
        <img
          src={image || "/placeholder.svg"}
          alt={displayTitle}
          className="h-full w-full object-contain rounded-md group-hover:scale-105 transition duration-300"
        />
      </div>
      ...
      <div className="w-full text-left">
        {/* Title */}
        <p className="truncate text-gray-800 font-semibold text-sm md:text-base">
          {displayTitle}
        </p>
        ...
        {/* Price */}
        <p className="text-green-700 font-bold text-sm md:text-base mt-2">
          ₼ {price}
        </p>
      </div>
    </div>

  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-[2rem]">
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
        className="bg-white p-5 rounded-2xl shadow-lg w-full md:w-[35%] h-[360px] overflow-y-auto border border-gray-100"
      >
...
>
  {/* Floating Icon */}
  <div className="absolute top-2 left-2 bg-white shadow-lg rounded-full p-1.5 z-10 border border-gray-200">
  ...
  <div className="w-full h-[150px] bg-gray-50 flex justify-center items-center overflow-hidden rounded-t-2xl relative">
    <img
      src={item.pictures?.[0] ? `/${item.pictures[0]}` : "/placeholder.svg"}
      alt={item.title}

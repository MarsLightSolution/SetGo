...
const OrderDetail = () => {
  ...
  const handleNotifyClick = async () => {
    ...
    try {
      ...
      showSuccessToast("✅ Order marked as delivered successfully!");
    } catch (err) {
      console.error("Failed to notify delivery:", err);
      setNotifyClicked(false); // rollback if failed
      showErrorToast("❌ Failed to mark order as delivered");
    } finally {
                  ...
                  <div className="space-y-2 w-full">
                    ...
                    <div className="flex items-center bg-blue-50 border border-blue-200 rounded-md px-4 py-2 gap-4">
                      ...
                      <button
                        ...
                        disabled={notifyClicked || notifyLoading}
                        className={`text-sm px-3 py-1 rounded-md transition flex items-center justify-center cursor-pointer ${
                          notifyClicked
